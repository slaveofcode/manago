<script>
  ...
  function handleToggle() {
    dispatch('toggle', !integration.enabled);
  }
  ...
  <div class="flex items-center justify-between">
    <div class="flex items-center space-x-2">
      <div class="h-8 w-8 rounded-full bg-primary/10 flex items-center justify-center text-primary">
        <!-- Icon based on integration type -->
      ...
      <div>
        ...
        <p class="text-xs text-muted-foreground">Added on {formatDate(integration.createdAt)}</p>
      </div>
    </div>
    <div class="flex items-center space-x-2">
      <label class="relative inline-flex items-center cursor-pointer">
        ...
        <span class="sr-only">Enable integration</span>
      </label>
      <button 
      ...
      <button 
        ...
        class="p-1 rounded-md hover:bg-destructive/10 hover:text-destructive"
